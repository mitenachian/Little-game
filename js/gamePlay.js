...
const gamePlay = {
    ...
    preload: function(){ // 載入資源
        ...
        this.load.image('stone1', 'Little-game/images/Stone1.png');
        this.load.image('stone2', 'Little-game/images/Stone2.png');
        this.load.image('stone3', 'Little-game/images/Stone1.png');
        this.load.image('planet1', 'Little-game/images/Planet1.png');
        this.load.image('planet2', 'Little-game/images/Planet2.png');
        this.load.image('success', 'Little-game/images/m_Success.png');
        this.load.image('gameOver', 'Little-game/images/gameover-text.png');
        this.load.image('playAgainbtn', 'Little-game/images/playAgain.png');
    ...
    update: function(){// 遊戲狀態更新,不斷更新60FPS
        ...
        if(this.timeInt < 30 && this.timeInt > 0 ){
            ...
            this.planetArr2[this.mas2Idx2].x -= 2 * this.speedLv;
        }
        // 檢測怪物是否超出邊界然後返回
